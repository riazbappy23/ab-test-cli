...
`;
    ...
    function updateSearchFilterBtn() {
    ...
    function urlObserver() {
        const debouncedUpdate = debounce(updateSearchFilterBtn, 150);
        ...
        window.addEventListener("pushstate", debouncedUpdate);
    }
