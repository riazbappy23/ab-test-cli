(async () => {
    ...
    const css = `
        @media (max-width: 767px) {
            ...
            .AB-NW8A .nav-main__ctas a .nw8a-cta__arrow {
                flex-shrink : 0;
                width       : 40px;
                height      : auto;
            }
