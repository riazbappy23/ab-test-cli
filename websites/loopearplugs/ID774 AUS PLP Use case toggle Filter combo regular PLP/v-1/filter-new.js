...
<path d="M13.5249 9.13525C14.4636 9.47849 15.273 10.0765 15.863 10.8422" stroke="#252427" stroke-width="1.5" stroke-linecap="round"/>
        ...
        "Use cases": {
            "Noise sensitivity": {
                ...
                filterParam: "gid://shopify/Metaobject/86831333714",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            Sleep: {
                name: "Sleep",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831104338",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            "Music & events": {
                name: "Music & events",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831366482",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            Focus: {
                name: "Focus",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831300946",
...
<path d="M9.12036 14.1783C9.1204 13.6802 9.52786 13.2764 10.0305 13.2764L17.3113 13.2764C17.8139 13.2764 18.2214 13.6802 18.2214 14.1783C18.2214 14.6764 17.814 15.0802 17.3113 15.0802L10.0305 15.0802C9.52783 15.0802 9.12036 14.6764 9.12036 14.1783Z" fill="#252427"/>
            ...
            Conversation: {
                name: "Conversation",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831038802",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            "Social gatherings": {
                ...
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831169874",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            "Playtime & school time": {
                ...
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831235410",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            Parenting: {
                name: "Parenting",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831071570",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            Travel: {
                name: "Travel",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831137106",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            Motorcycling: {
                name: "Motorcycling",
                type: "filter_use_case",
                filterParam: "gid://shopify/Metaobject/86831399250",
                icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
    ...
    function addHeaderAndFilterTrigger() {
        waitForElem("#ProductGridContainer .collection h2", (headings) => {
            const firstHeading = headings[0];
            const firstCollection = firstHeading.closest(".collection");

            if (firstCollection && !hf.query(`.${tid}-shop-toggle-row`)) {
                firstCollection.insertAdjacentHTML(
                    "beforebegin",
                    `
          <div class="container-xxl ${tid}-shop-toggle-row">
            <h1 class="${tid}-shop-title">Shop</h1>
            <div class="${tid}-usecase-toggle-wrap">
              <span class="${tid}-usecase-toggle-label">Use cases</span>
              <button class="${tid}-usecase-toggle" type="button" role="switch" aria-checked="true" aria-label="Use cases">
            ...
            if (!firstHeading.classList.contains(`${tid}-collection-heading`)) {
                firstHeading.classList.add(`${tid}-collection-heading`);
            }

            if (!firstHeading.parentElement.classList.contains(`${tid}-collection-heading-row`)) {
                firstHeading.parentElement.classList.add(`${tid}-collection-heading-row`);
            }

            if (!hf.query(`.${tid}-filter-trigger-wrapper`)) {
          ...
          <div class="${tid}-filter-trigger-wrapper">
            <div class="${tid}-filter-trigger-container">
              ...
              <div class="${tid}-filter-trigger-count-wrapper">
                ...
                const trigger = hf.query(`.${tid}-filter-trigger-wrapper`);
                if (trigger.parentElement !== firstHeading.parentElement) {
                    firstHeading.insertAdjacentElement("afterend", trigger);
                }
            }
        });
    }
        ...
        `
            ...
            `
              ...
              `
                                    ...
                                    if (hf.query(`.${tid}-filter-trigger-count`)) hf.query(`.${tid}-filter-trigger-count`).textContent = "(" + hf.queryAll(`.${tid}-filter-item-active`).length + ")";
                            ...
                            hf.forcePush(
                                () => {
                                    if (hf.query(`.${tid}-filter-item-count`)) hf.query(`.${tid}-filter-item-count`).textContent = hf.queryAll("#ProductGridContainer .product-card")?.length + " " + (hf.queryAll("#ProductGridContainer .product-card")?.length == 1 ? "result" : "results");
                                },
                                2000,
                                500
                            );
